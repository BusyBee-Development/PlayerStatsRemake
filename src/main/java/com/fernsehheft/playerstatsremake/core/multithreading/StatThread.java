...
import com.fernsehheft.playerstatsremake.api.events.StatCalculatedEvent;
...
final class StatThread extends Thread {
    ...
    public void run() throws IllegalStateException {
        ...
        try {
            ...
            // Fire StatCalculatedEvent to expose the result for external integrations
            // like DiscordSRV (PR #174)
